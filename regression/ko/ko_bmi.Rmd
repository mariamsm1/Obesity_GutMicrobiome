...
results_version <- '250128'
##################################################################################################################################
# Source the helper functions
source(here::here('bmi_paper_model_fitting_helper_functions_250128.R'))
...
data_ko <- data_ko[complete.cases(data_ko$UNRELATED_1_DEGREE),]
...
for(curr_model in model_names){
    ...
    curr_results <- get_results_for_bmi_paper(d = data,
                                              ...
                                              ko_sex_interaction = model_with_interaction[[curr_model]],
                                              sex_var = 'male')
...
interaction_df <- all_results_main %>%
    filter(grepl("int", model_name) & grepl(":maleTRUE", ko))
...
interaction_df <- interaction_df[,c("analysis", "outcome","cohort","model_name","ko","n_obs","est","se","ci_low","ci_high",
                      "p", "p_value_adj")]
...
results$outcome <- "BMI"
results <- results[,c("analysis", "outcome","cohort","model_name","ko","n_obs","est","se","ci_low","ci_high",
                      "p", "p_value_adj")]
...
## save
```{r}
export(all_results, "/Volumes/research/metabogut/BMI_2021/analysisv3.0/regression/ko/ko_as_exposure/results/results_241223.xlsx")
```
